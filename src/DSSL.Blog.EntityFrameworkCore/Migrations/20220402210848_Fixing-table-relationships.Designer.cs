...
namespace DSSL.Blog.Migrations
{
    ...
    [Migration("20220402210848_Fixing-table-relationships")]
    partial class Fixingtablerelationships
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DSSL.Blog.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("DSSL.Blog.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DSSL.Blog.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DSSL.Blog.Comments.Comment", b =>
                {
                    b.HasOne("DSSL.Blog.Posts.Post", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DSSL.Blog.Posts.Post", b =>
                {
                    b.HasOne("DSSL.Blog.Authors.Author", null)
                        .WithMany()
